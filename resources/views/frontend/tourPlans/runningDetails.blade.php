        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="common_bannner_text">
                    <h2>Runningt Plan Details</h2>
                    <ul>
                        <li><a href="{{ url("/") }}">Home</a></li>
                        <li><span><i class="fas fa-circle"></i></span>Runningt Plan Details</li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div class="contact_form">
                                    <form action="" method="POST">
                                        ...
                                        <div class="mt-3 col-lg-12">
                                            <div class="form-group">
                                                <button type="button" class="btn btn_theme btn_md">Post Comment</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
